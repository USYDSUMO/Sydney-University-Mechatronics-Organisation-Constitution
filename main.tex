...
%%%%%%%%%%%%%%%%%%%%%   NOTE:  %%%%%%%%%%%%%%%%%%%%%%%%%
% The only changes which are to be made in THIS CURRENT REV0 of this document are just the 
% de-capitalisation of each section's name, as well as the removal of the dot after each section number
% All indentation will remain identical where at all possible (and if not, it shall be recorded)
% ALL MISTAKES will be LEFT in this current document, including full-stops missing, etc - 08/11/2020
% For outer enumerations: \begin{enumerate}[\thesection .1]
% For inner enumerations: \begin{enumerate}[\hspace{5mm}\thesection.\theenumi.\arabic{enumii}.]


% Changelog when converting to LaTeX
% ADDED a cover page 
% Added a table of contents 
% ADDED page numbering in this revision.
% Removed the header and horizontal line separator
% Removed the tab at 5.1.2
% Changed font colours for TOC, headings and subheadings to sumo blue RGB(0,63,96)
% Removal of pagebreak before 14
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}[\thesection .1]
    ...
    \begin{enumerate}[\hspace{5mm}\thesection.\theenumi.\arabic{enumii}.]
        ...
        % The below indentation wasn't rendered by LaTeX, but was there in the original one. TODO make a changenote
    ...
    \begin{enumerate}[\hspace{5mm}\thesection.\theenumi.\arabic{enumii}.]
        ...
        \item Being a signatory on the society’s accounts
    \end{enumerate}
    % Note that the numbering is off intentionally below
    ...
    \begin{enumerate}[\hspace{5mm}5.5.1]
        ...
        \item Being a signatory on the society’s accounts
    \end{enumerate}
    % TODO NOTE: The numbering here is intentionally wrong! To be changed
    \item The Junior Vice President shall:
    \begin{enumerate}[\hspace{5mm}5.3.1]
        \item Deputise for the Vice President
        % What is a respectable standard? What is a common room? TODO fix 
...
\begin{enumerate}[\thesection .1]
    ...
    % Yes, the below enumeration is originally like this
    ...
    % Mixed enumeration with roman numerals. Sad!
...
\begin{enumerate}[\thesection .1]
    ...
    % Non italicised "Ordinary Members"
...
\begin{enumerate}[\thesection .1]
    ...
    % Commas and capitalisation below
    \begin{enumerate}[\hspace{5mm}1.]
